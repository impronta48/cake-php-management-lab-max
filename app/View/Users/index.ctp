<div class="users index">
	...
	<div class="row">
		...
		<li><?php echo $this->Html->link('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New'.__('Manager'), array('controller' => 'users', 'action' => 'add'), array('escape' => false)); ?> </li>
		<li><?php echo $this->Html->link('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;List'.__('Tasks'), array('controller' => 'tasks', 'action' => 'index'), array('escape' => false)); ?> </li>
		<li><?php echo $this->Html->link('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New'.__('Task'), array('controller' => 'tasks', 'action' => 'add'), array('escape' => false)); ?> </li>
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th nowrap><?php echo $this->Paginator->sort('manager_id'); ?></th>
						<th class="actions"></th>
					</tr>
				</thead>
				<tbody>
				<?php foreach ($users as $user): ?>
					<tr>
						...
						<td nowrap><?php echo h($user['User']['password']); ?>&nbsp;</td>
								<td>
			<?php echo $this->Html->link($user['Manager']['username'], array('controller' => 'users', 'action' => 'view', $user['Manager']['id'])); ?>
		</td>
						<td class="actions">
